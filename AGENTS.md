...
| `start` | `skills/start/SKILL.md` | First-time guided setup: collects rules/considerations, then creates profiles. |
...
- "start / get started / set up / first time / comenzar / empezar / iniciar / configurar" → `skills/start/SKILL.md` (first-time setup).
